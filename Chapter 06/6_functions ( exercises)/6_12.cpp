...
void divide(double arg1, double arg2)
{
    if (arg2 == 0.0)
    {
        ...
        return; // divide function immediately ends and cout in 34th line does not execute.
    }
    cout << "The quotient is " << (arg1 / arg2) << endl;
}

// When the return statement is encountered, 
// the function immediately terminates and control of the program returns to the statement that called the function.
